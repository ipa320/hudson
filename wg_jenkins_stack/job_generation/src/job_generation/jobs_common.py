...
FHG_STACKS_PUBLIC = ['cob_android', 'cob_extern', 'cob_common', 'cob_calibration', 'cob_calibration_data',  'cob_driver', 'cob_driver_sandbox', 'cob_robots', 'cob_environments', 'cob_simulation', 'cob_apps', 'cob_manipulation', 'cob_manipulation_sandbox', 'cob_object_manipulation', 'cob_navigation', 'cob_perception_common', 'cob_environment_perception', 'cob_people_perception', 'cob_object_perception', 'cob_scenario_states', 'cob_scenario_tools', 'cob_scenarios', 'cob_web', 'cob_command_tools', 'cob_tutorials', 'schunk_modular_robotics', 'schunk_robots', 'schunk_simulation', 'srs_common', 'srs_public', 'cob_substitute']
