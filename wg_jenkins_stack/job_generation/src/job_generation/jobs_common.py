...
FHG_STACKS_PUBLIC = ['cob_extern', 'cob_common', 'cob_driver', 'cob_robots', 'cob_simulation', 'cob_apps', 'cob_manipulation', 'cob_navigation', 'cob_environment_perception', 'cob_people_perception', 'cob_object_perception', 'cob_scenarios', 'cob_web', 'schunk_modular_robotics', 'schunk_robots']
